...
// Admin Panel + All Apps — localStorage bridge
// ═══════════════════════════════════════════════
...
const store = {
  ...
  set: (key, val) => { try { localStorage.setItem(PREFIX + key, JSON.stringify(val)); } catch {} },
};
...
const SEED = {
  ...
  shopkeepers: [
    ...
    { id: 'sk3', name: 'Vivek Sharma', phone: '9333333333', shopId: 'sh3', status: 'pending', avatar: 'V', createdAt: '2026-03-05T12:00:00.000Z' },
  ...
  shops: [
    ...
    { id: 'sh3', ownerId: 'sk3', ownerPhone: '9333333333', name: 'Tech World', nameEn: 'Tech World Betul', category: 'electronics', emoji: '💻', tagline: 'सभी Electronics सबसे कम दाम पर', address: 'कॉलेज रोड, बैतूल', city: 'Betul', status: 'pending', commissionRate: 10, rating: 0, totalOrders: 0, totalEarnings: 0, createdAt: '2026-03-05T12:00:00.000Z' },
    { id: 'sh4', ownerId: 'sk4', ownerPhone: '9444444444', name: 'साईं मेडिकल', nameEn: 'Sai Medical Store', category: 'medical', emoji: '💊', tagline: '24x7 दवाइयाँ और स्वास्थ्य उत्पाद', address: 'हॉस्पिटल रोड, बैतूल', city: 'Betul', status: 'approved', commissionRate: 8, rating: 4.6, totalOrders: 38, totalEarnings: 22400, createdAt: '2026-03-03T10:00:00.000Z' },
  ],
  products: [
    ...
    { id: 'pr7', shopId: 'sh2', name: 'Women Kurti', emoji: '👘', price: 799, unit: 'pcs', stock: 25, category: 'fashion', isActive: true, createdAt: '2026-03-02T10:00:00.000Z' },
    { id: 'pr8', shopId: 'sh2', name: 'Jeans', emoji: '👖', price: 999, unit: 'pcs', stock: 20, category: 'fashion', isActive: false, createdAt: '2026-03-02T10:00:00.000Z' },
    ...
    { id: 'pr10', shopId: 'sh4', name: 'Vitamin C', emoji: '🍋', price: 120, unit: 'bottle', stock: 50, category: 'medical', isActive: true, createdAt: '2026-03-03T11:00:00.000Z' },
  ],
  deliveryPartners: [
  ...
  listings: [
    ...
    { id: 'l3', title: '3BHK Flat for Rent', price: 8000, category: 'realestate', emoji: '🏠', description: 'नया flat, सभी सुविधाएं, road से 100 meter.', location: 'कॉलेज रोड, बैतूल', postedBy: 'Suresh Kumar', phone: '9876543212', timeAgo: '1 दिन पहले', isVerified: true, status: 'approved', views: 312, createdAt: '2026-03-04T08:00:00.000Z' },
    ...
    { id: 'l5', title: 'Maruti Alto 800 - 2019', price: 280000, category: 'cars', emoji: '🚗', description: 'Single owner, AC, 45000 km. All docs clear.', location: 'बैतूल', postedBy: 'Vikram Singh', phone: '9876543214', timeAgo: '3 दिन पहले', isVerified: true, status: 'approved', views: 445, createdAt: '2026-03-02T09:00:00.000Z' },
  ],
  orders: [
    { id: 'o1', userId: 'u1', userName: 'Ramesh Kumar', phone: '9876543210', shopId: 'sh1', items: [{ id: 'pr1', name: 'अंडे', emoji: '🥚', price: 8, quantity: 6, unit: 'pcs' }, { id: 'pr2', name: 'दूध', emoji: '🥛', price: 55, quantity: 1, unit: 'litre' }], total: 103, commission: 10, shopEarning: 93, deliveryFee: 0, deliveryBoyId: 'dp1', deliveryBoyName: 'Raju Yadav', promoDiscount: 0, address: 'MIG Colony, Sector 4, Betul', slot: 'सुबह 7-9 बजे', payment: 'cod', status: 'delivered', category: 'essentials', createdAt: '2026-03-05T05:30:00.000Z' },
    { id: 'o2', userId: 'u2', userName: 'Priya Singh', phone: '8765432109', shopId: 'sh1', items: [{ id: 'pr3', name: 'डबल रोटी', emoji: '🍞', price: 35, quantity: 2, unit: 'loaf' }], total: 130, commission: 13, shopEarning: 117, deliveryFee: 0, deliveryBoyId: 'dp2', deliveryBoyName: 'Sonu Patel', promoDiscount: 13, address: 'Station Road, Betul', slot: 'सुबह 10-12 बजे', payment: 'upi', status: 'dispatched', category: 'essentials', createdAt: '2026-03-05T06:00:00.000Z' },
    { id: 'o3', userId: 'u5', userName: 'Meera Joshi', phone: '5432109876', shopId: 'sh2', items: [{ id: 'pr6', name: 'Men T-Shirt', emoji: '👕', price: 599, quantity: 2, unit: 'pcs' }], total: 1198, commission: 120, shopEarning: 1078, deliveryFee: 0, deliveryBoyId: null, deliveryBoyName: null, promoDiscount: 0, address: 'Nehru Nagar, Betul', slot: 'शाम 5-7 बजे', payment: 'card', status: 'accepted', category: 'fashion', createdAt: '2026-03-05T08:30:00.000Z' },
    { id: 'o4', userId: 'u6', userName: 'Vikas Sharma', phone: '4321098765', shopId: 'sh1', items: [{ id: 'pr4', name: 'आलू', emoji: '🥔', price: 40, quantity: 2, unit: 'kg' }, { id: 'pr5', name: 'टमाटर', emoji: '🍅', price: 35, quantity: 1, unit: 'kg' }], total: 115, commission: 12, shopEarning: 103, deliveryFee: 20, deliveryBoyId: null, deliveryBoyName: null, promoDiscount: 0, address: 'Sarni Road, Betul', slot: 'सुबह 7-9 बजे', payment: 'cod', status: 'pending', category: 'essentials', createdAt: '2026-03-05T09:00:00.000Z' },
  ],
  notifications: [
    { id: 'n1', type: 'order', icon: '🆕', title: 'New shop registration: Tech World', body: 'Pending approval', time: '2026-03-05T08:30:00.000Z', read: false, forAdmin: true },
    ...
    { id: 'n4', type: 'order', icon: '📦', title: 'Order #o4 pending delivery assignment', body: 'Vikas Sharma — ₹115', time: '2026-03-05T09:00:00.000Z', read: false, forAdmin: true },
    ...
    { id: 'n8', type: 'order', icon: '🛍️', title: 'New order! ₹103', body: 'From Ramesh Kumar — 2 items', time: '2026-03-05T05:30:00.000Z', read: true, forAdmin: false, forShop: true, shopId: 'sh1' },
    { id: 'n9', type: 'order', icon: '🛍️', title: 'New order! ₹115', body: 'From Vikas Sharma — 2 items', time: '2026-03-05T09:00:00.000Z', read: false, forAdmin: false, forShop: true, shopId: 'sh1' },
  ],
  promoCodes: [
...
export const saveUser = (userData) => {
  ...
  else users.push({ ...userData, id: userData.id || uid(), createdAt: now(), orders: 0, avatar: (userData.name || 'U')[0].toUpperCase() });
  store.set('users', users);
  return users.find(u => u.id === userData.id || u.phone === userData.phone);
};
export const blockUser = (id) => { store.set('users', getUsers().map(u => u.id === id ? { ...u, status: 'blocked' } : u)); };
export const unblockUser = (id) => { store.set('users', getUsers().map(u => u.id === id ? { ...u, status: 'active' } : u)); };
export const deleteUser = (id) => { store.set('users', getUsers().filter(u => u.id !== id)); };
...
// SHOPS
// ════════════════════════════════════════════════
export const getShops = (statusFilter = null) => {
  init();
  const shops = store.get('shops') || [];
  return statusFilter ? shops.filter(s => s.status === statusFilter) : shops;
};
export const getShopById = (id) => getShops().find(s => s.id === id);
export const getShopByOwnerId = (ownerId) => getShops().find(s => s.ownerId === ownerId);
export const getShopByOwnerPhone = (phone) => getShops().find(s => s.ownerPhone === phone);
export const saveShop = (shopData) => {
  init();
  ...
  if (idx >= 0) {
    ...
    shops.push({ ...shopData, id: 'sh' + uid(), status: 'pending', rating: 0, totalOrders: 0, totalEarnings: 0, createdAt: now() });
    addNotification({ type: 'shop', icon: '🏪', title: `New shop: ${shopData.name}`, body: 'Pending approval', forAdmin: true });
  }
  store.set('shops', shops);
  return store.get('shops').find(s => s.id === shopData.id || s.ownerPhone === shopData.ownerPhone);
};
export const approveShop = (id) => {
  store.set('shops', getShops().map(s => s.id === id ? { ...s, status: 'approved' } : s));
  const shop = getShopById(id);
  if (shop) store.set('shopkeepers', getShopkeepers().map(sk => sk.shopId === id || sk.id === shop.ownerId ? { ...sk, status: 'active' } : sk));
};
export const suspendShop = (id) => { store.set('shops', getShops().map(s => s.id === id ? { ...s, status: 'suspended' } : s)); };
export const deleteShop = (id) => { store.set('shops', getShops().filter(s => s.id !== id)); };
...
export const saveProduct = (productData) => {
  ...
  else products.push({ ...productData, id: 'pr' + uid(), isActive: true, createdAt: now() });
  store.set('products', products);
};
export const deleteProduct = (id) => { store.set('products', getProducts().filter(p => p.id !== id)); };
export const toggleProductActive = (id) => {
  store.set('products', getProducts().map(p => p.id === id ? { ...p, isActive: !p.isActive } : p));
};
export const reduceStock = (productId, qty) => {
  store.set('products', getProducts().map(p => p.id === productId
    ? { ...p, stock: Math.max(0, (p.stock || 0) - qty), isActive: Math.max(0, (p.stock || 0) - qty) > 0 ? p.isActive : false }
    : p));
};
...
export const saveDeliveryPartner = (dpData) => {
  ...
  if (idx >= 0) dps[idx] = { ...dps[idx], ...dpData };
    ...
    dps.push({ ...dpData, id: 'dp' + uid(), isOnline: false, isAvailable: true, activeOrders: 0, totalDeliveries: 0, todayDeliveries: 0, todayEarnings: 0, totalEarnings: 0, rating: 5.0, status: 'pending', createdAt: now(), avatar: (dpData.name || 'D')[0].toUpperCase() });
    addNotification({ type: 'delivery', icon: '🚴', title: `New delivery partner: ${dpData.name}`, body: 'Pending approval', forAdmin: true });
  }
...
export const setDeliveryPartnerOnline = (id, isOnline) => {
  store.set('deliveryPartners', getDeliveryPartners().map(dp => dp.id === id ? { ...dp, isOnline, isAvailable: isOnline } : dp));
};
export const approveDeliveryPartner = (id) => {
  store.set('deliveryPartners', getDeliveryPartners().map(dp => dp.id === id ? { ...dp, status: 'active' } : dp));
};
export const suspendDeliveryPartner = (id) => {
  store.set('deliveryPartners', getDeliveryPartners().map(dp => dp.id === id ? { ...dp, status: 'suspended', isOnline: false } : dp));
};

// Auto-assign nearest available delivery boy
export const autoAssignDelivery = (orderId) => {
  const available = getDeliveryPartners().filter(dp => dp.isOnline && dp.isAvailable && dp.activeOrders < 2 && dp.status === 'active');
  if (available.length === 0) return null;
  const best = available.sort((a, b) => a.activeOrders - b.activeOrders)[0];
  const orders = store.get('orders') || [];
  const updated = orders.map(o => o.id === orderId ? { ...o, deliveryBoyId: best.id, deliveryBoyName: best.name, status: 'dispatched' } : o);
  store.set('orders', updated);
  store.set('deliveryPartners', getDeliveryPartners().map(dp => dp.id === best.id
    ? { ...dp, activeOrders: dp.activeOrders + 1, isAvailable: dp.activeOrders + 1 < 2 } : dp));
  addNotification({ type: 'delivery', icon: '🚴', title: `Assigned to ${best.name}`, body: `Order #${orderId} dispatched`, forAdmin: true });
  const order = updated.find(o => o.id === orderId);
  if (order) addNotification({ type: 'delivery', icon: '🚴', title: 'Order On The Way!', body: `${best.name} is delivering your order`, forAdmin: false, userId: order.userId });
  return best;
};
...
export const saveAd = (adData) => {
  ...
  if (idx >= 0) ads[idx] = { ...ads[idx], ...adData };
  else { ads.push({ ...adData, id: uid(), status: 'pending', views: 0, calls: 0, createdAt: now() }); addNotification({ type: 'ad', icon: '🆕', title: `New ad: ${adData.shopName}`, body: 'Pending approval', forAdmin: true }); }
  store.set('ads', ads);
};
export const approveAd = (id) => { store.set('ads', getAds().map(a => a.id === id ? { ...a, status: 'approved' } : a)); };
export const rejectAd = (id) => { store.set('ads', getAds().map(a => a.id === id ? { ...a, status: 'rejected' } : a)); };
export const deleteAd = (id) => { store.set('ads', getAds().filter(a => a.id !== id)); };
export const incrementAdView = (id) => { store.set('ads', getAds().map(a => a.id === id ? { ...a, views: (a.views || 0) + 1 } : a)); };
export const incrementAdCall = (id) => { store.set('ads', getAds().map(a => a.id === id ? { ...a, calls: (a.calls || 0) + 1 } : a)); };
...
export const saveListing = (listingData) => {
  ...
  if (idx >= 0) listings[idx] = { ...listings[idx], ...listingData };
  else { listings.unshift({ ...listingData, id: uid(), status: 'pending', views: 0, createdAt: now(), timeAgo: 'just now' }); addNotification({ type: 'listing', icon: '🛍️', title: `New listing: ${listingData.title}`, body: 'Pending approval', forAdmin: true }); }
  store.set('listings', listings);
};
export const approveListing = (id) => { store.set('listings', getListings().map(l => l.id === id ? { ...l, status: 'approved' } : l)); };
export const rejectListing = (id) => { store.set('listings', getListings().map(l => l.id === id ? { ...l, status: 'rejected' } : l)); };
export const featureListing = (id) => { store.set('listings', getListings().map(l => l.id === id ? { ...l, featured: !l.featured } : l)); };
export const deleteListing = (id) => { store.set('listings', getListings().filter(l => l.id !== id)); };
...
export const saveOrder = (orderData) => {
  ...
  const commissionRate = orderData.commissionRate || settings.commissionRate || 10;
  const commission = Math.round((orderData.total * commissionRate) / 100);
  const newOrder = { ...orderData, id: 'o' + uid(), status: 'pending', commission, shopEarning: orderData.total - commission, deliveryBoyId: null, deliveryBoyName: null, createdAt: now() };
  orders.unshift(newOrder);
  store.set('orders', orders);
  store.set('users', getUsers().map(u => u.id === orderData.userId ? { ...u, orders: (u.orders || 0) + 1 } : u));
  addNotification({ type: 'order', icon: '🛒', title: `New order: ${orderData.userName}`, body: `₹${orderData.total}`, forAdmin: true });
  addNotification({ type: 'order', icon: '🎉', title: 'Order Confirmed!', body: `Your order of ₹${orderData.total} placed.`, forAdmin: false, userId: orderData.userId });
  if (orderData.shopId) addNotification({ type: 'order', icon: '🛍️', title: `New order! ₹${orderData.total}`, body: `${orderData.userName} — ${(orderData.items || []).length} item(s)`, forAdmin: false, forShop: true, shopId: orderData.shopId });
  return newOrder;
};
...
export const updateOrderStatus = (id, status) => {
  ...
  if (order) {
    const msgs = { accepted: '✅ Shop accepted your order!', rejected: '❌ Order rejected by shop.', dispatched: '🚴 Your order is on the way!', delivered: '✅ Order delivered! Enjoy.', cancelled: '❌ Order cancelled.' };
    if (msgs[status]) addNotification({ type: 'delivery', icon: msgs[status][0], title: msgs[status].slice(2), body: `Order #${id} — ₹${order.total}`, forAdmin: false, userId: order.userId });
    if (status === 'delivered') {
      store.set('shops', getShops().map(s => s.id === order.shopId ? { ...s, totalOrders: (s.totalOrders || 0) + 1, totalEarnings: (s.totalEarnings || 0) + (order.shopEarning || 0) } : s));
      if (order.deliveryBoyId) {
        store.set('deliveryPartners', getDeliveryPartners().map(dp => dp.id === order.deliveryBoyId
          ? { ...dp, activeOrders: Math.max(0, dp.activeOrders - 1), isAvailable: true, totalDeliveries: dp.totalDeliveries + 1, todayDeliveries: dp.todayDeliveries + 1, todayEarnings: dp.todayEarnings + (order.deliveryFee || 30), totalEarnings: dp.totalEarnings + (order.deliveryFee || 30) }
          : dp));
      }
    }
  }
...
export const acceptOrderByShop = (orderId) => {
  updateOrderStatus(orderId, 'accepted');
  autoAssignDelivery(orderId);
};

export const rejectOrderByShop = (orderId, reason = '') => {
  const orders = (store.get('orders') || []).map(o => o.id === orderId ? { ...o, status: 'rejected', rejectedReason: reason, updatedAt: now() } : o);
  store.set('orders', orders);
  const order = orders.find(o => o.id === orderId);
  if (order) addNotification({ type: 'order', icon: '❌', title: 'Order Rejected', body: `Order #${orderId} rejected by shop.`, forAdmin: false, userId: order.userId });
};

export const deleteOrder = (id) => { store.set('orders', getOrders().filter(o => o.id !== id)); };
...
export const markNotifRead = (id) => { store.set('notifications', (store.get('notifications') || []).map(n => n.id === id ? { ...n, read: true } : n)); };
export const markAllNotifsRead = (forAdmin = false, userId = null, shopId = null) => {
  store.set('notifications', (store.get('notifications') || []).map(n => {
    if (forAdmin && n.forAdmin) return { ...n, read: true };
    if (shopId && n.shopId === shopId) return { ...n, read: true };
...
export const savePromoCode = (promoData) => {
  ...
  if (idx >= 0) promos[idx] = { ...promos[idx], ...promoData }; else promos.push(promoData);
  store.set('promoCodes', promos);
};
export const deletePromoCode = (code) => { store.set('promoCodes', getPromoCodes().filter(p => p.code !== code)); };
...
export const getStats = () => {
  const users = getUsers(), ads = getAds(), listings = getListings(), orders = getOrders(), shops = getShops(), dps = getDeliveryPartners();
  const revenue = orders.filter(o => o.status !== 'cancelled').reduce((s, o) => s + (o.total || 0), 0);
  const commission = orders.filter(o => o.status === 'delivered').reduce((s, o) => s + (o.commission || 0), 0);
  return {
    ...
    totalDeliveryPartners: dps.filter(dp => dp.status === 'active').length,
    onlineDeliveryPartners: dps.filter(dp => dp.isOnline).length,
    revenue,
    commission,
    revenueFormatted: revenue >= 1000 ? `₹${(revenue / 1000).toFixed(1)}K` : `₹${revenue}`,
    commissionFormatted: commission >= 1000 ? `₹${(commission / 1000).toFixed(1)}K` : `₹${commission}`,
  };
};

// ── RESET ──
export const resetStore = () => { Object.keys(localStorage).filter(k => k.startsWith(PREFIX)).forEach(k => localStorage.removeItem(k)); };
